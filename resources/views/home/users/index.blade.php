...
@section('content_header')
    <div class="row mb-2">
        ...
        <div class="col-sm-12">
            <h1><span class="badge badge-secondary">{{count($users)+1}}</span> {{$tipo??"Usuarios"}}</h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{url("/")}}/home/users/create?tipo={{$tipo=="Gerentes"?'gerentes':'promotores'}}" type="button" class="btn btn-block btn-success text-white">
                ...
                <div class="card-body">
                    <table id="resources" class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>{{$user->name}}</td>
                            <td>
                                <img src="{{url("/")}}/storage/{{$user->avatar}}" class="user-image img-circle" width="20" alt="{{$user->name}}">
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{url("home/users/$user->id/edit")}}" class="btn btn-info btn-xs">
