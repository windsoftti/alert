...
@section('content_header')
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1> <span class="badge badge-secondary">{{count($prospectos)}}</span> Solicitantes del Gerente: <span class="badge badge-secondary">{{auth()->user()->name}}</span></h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url("/")}}">Inicio</a></li>
                <li class="breadcrumb-item active">Solicitantes del Gerente {{auth()->user()->name}}</li>
            </ol>
        </div>
    </div>
@stop
